...
class ControllerModuleBlog extends Controller {
    ...
    private function addBasicLang($array = array())
    {
        ...
        $data['link_blog_dashboard'] = $this->url->link('module/blog', 'token=' . $this->session->data['token'], 'SSL');
        $data['link_add_edit_categories'] = $this->url->link('module/blog/category_list', 'token=' . $this->session->data['token'], 'SSL');
        $data['link_add_edit_articles'] = $this->url->link('module/blog/article_list', 'token=' . $this->session->data['token'], 'SSL');
        $data['link_add_edit_authors'] = $this->url->link('module/blog/author_list', 'token=' . $this->session->data['token'], 'SSL');
        $data['link_add_edit_comments'] = $this->url->link('module/blog/comment_list', 'token=' . $this->session->data['token'], 'SSL');
        $data['link_general_settings'] = $this->url->link('module/blog/settings', 'token=' . $this->session->data['token'], 'SSL');
        
        $data['link_blog_category'] = $this->url->link('module/blog_category', 'token=' . $this->session->data['token'], 'SSL');
        $data['link_blog_search'] = $this->url->link('module/blog_search', 'token=' . $this->session->data['token'], 'SSL');
        $data['link_blog_latest_post'] = $this->url->link('module/blog_latest', 'token=' . $this->session->data['token'], 'SSL');
        $data['link_blog_popular_post'] = $this->url->link('module/blog_popular', 'token=' . $this->session->data['token'], 'SSL');
        $data['link_blog_product_related_post'] = $this->url->link('module/blog_related_post', 'token=' . $this->session->data['token'], 'SSL');
        $data['link_blog_popular_tags'] = $this->url->link('module/blog_tags', 'token=' . $this->session->data['token'], 'SSL');
	...
	public function index() {   
        ...
        $data['handy_box'] = $this->load->view('module/blog/partial/header.tpl', $data);
		$this->response->setOutput($this->load->view('module/blog/blog.tpl', $data));
	}
	...
	public function article_add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateArticleForm()) {
			...
			$this->response->redirect($this->url->link('module/blog/article_list', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getArticlesList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/blog/article_list', 'token=' . $this->session->data['token'], 'SSL')
		);

		$data['add'] = $this->url->link('module/blog/article_add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('module/blog/article_delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['articles'][] = array(
				...
				'author'  => '<a target="_blank" href="'.$this->url->link('module/blog/author_list', 'token=' . $this->session->data['token'] . '&author_id=' . $result['author_id'] . $url, 'SSL').'">'.$result['author'] .'</a>',
                'comments'    => $this->model_blog_comment->getTotalArticleComments($result['article_id']),
				'edit'        => $this->url->link('module/blog/article_edit', 'token=' . $this->session->data['token'] . '&article_id=' . $result['article_id'] . $url, 'SSL'),
				'delete'      => $this->url->link('module/blog/article_delete', 'token=' . $this->session->data['token'] . '&article_id=' . $result['article_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_title'] = $this->url->link('module/blog/article_list', 'token=' . $this->session->data['token'] . '&sort=title' . $url, 'SSL');
		$data['sort_date_published'] = $this->url->link('module/blog/article_list', 'token=' . $this->session->data['token'] . '&sort=date_published' . $url, 'SSL');
		$data['sort_author'] = $this->url->link('module/blog/article_list', 'token=' . $this->session->data['token'] . '&sort=author' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('module/blog/article_list', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$data['footer'] = $this->load->controller('common/footer');
        $data['handy_box'] = $this->load->view('module/blog/partial/header.tpl', $data);
		$this->response->setOutput($this->load->view('module/blog/article_list.tpl', $data));
	}
	...
	protected function getArticleForm() {
		...
		if (!isset($this->request->get['article_id'])) {
			$data['action'] = $this->url->link('module/blog/article_add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('module/blog/article_edit', 'token=' . $this->session->data['token'] . '&article_id=' . $this->request->get['article_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('module/blog/article_list', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$data['footer'] = $this->load->controller('common/footer');
        $data['handy_box'] = $this->load->view('module/blog/partial/header.tpl', $data);
		$this->response->setOutput($this->load->view('module/blog/article_form.tpl', $data));
	}
	...
	public function category_add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateCategoryForm()) {
			...
			$this->response->redirect($this->url->link('module/blog/category_list', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getCategoriesList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/blog/category_list', 'token=' . $this->session->data['token'], 'SSL')
		);

		$data['add'] = $this->url->link('module/blog/category_add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('module/blog/category_delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['categories'][] = array(
				...
				'edit'        => $this->url->link('module/blog/category_edit', 'token=' . $this->session->data['token'] . '&category_id=' . $result['category_id'] . $url, 'SSL'),
				'delete'      => $this->url->link('module/blog/category_delete', 'token=' . $this->session->data['token'] . '&category_id=' . $result['category_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('module/blog/category_list', 'token=' . $this->session->data['token'] . '&sort=name' . $url, 'SSL');
		$data['sort_sort_order'] = $this->url->link('module/blog/category_list', 'token=' . $this->session->data['token'] . '&sort=sort_order' . $url, 'SSL');
		...
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('module/blog/category_list', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$data['footer'] = $this->load->controller('common/footer');
        $data['handy_box'] = $this->load->view('module/blog/partial/header.tpl', $data);
		$this->response->setOutput($this->load->view('module/blog/category_list.tpl', $data));
	}
	...
	protected function getCategoryForm() {
		...
		if (!isset($this->request->get['category_id'])) {
			$data['action'] = $this->url->link('module/blog/category_add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('module/blog/category_edit', 'token=' . $this->session->data['token'] . '&category_id=' . $this->request->get['category_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('module/blog/category_list', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$data['footer'] = $this->load->controller('common/footer');
        $data['handy_box'] = $this->load->view('module/blog/partial/header.tpl', $data);
		$this->response->setOutput($this->load->view('module/blog/category_form.tpl', $data));
	}
	...
	public function comment_add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateCommentForm()) {
			...
			$this->response->redirect($this->url->link('module/blog/comment_list', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getCommentList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/blog/comment_list', 'token=' . $this->session->data['token'], 'SSL')
		);
        
		$data['add'] = $this->url->link('module/blog/comment_add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('module/blog/comment_delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			...
			$data['comments'][] = array(
                ...
                'article_href'     => $this->url->link('module/blog/article_edit', 'token=' . $this->session->data['token'] . '&article_id=' . $result['article_id'], 'SSL'),
				'edit'            => $this->url->link('module/blog/comment_edit', 'token=' . $this->session->data['token'] . '&comment_id=' . $result['comment_id'] . $url, 'SSL')
			);
		...
		$data['sort_name'] = $this->url->link('module/blog/comment_list', 'token=' . $this->session->data['token'] . '&sort=name' . $url, 'SSL');
		$data['sort_email'] = $this->url->link('module/blog/comment_list', 'token=' . $this->session->data['token'] . '&sort=email' . $url, 'SSL');
		$data['sort_date_added'] = $this->url->link('module/blog/comment_list', 'token=' . $this->session->data['token'] . '&sort=date_added' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('module/blog/comment_list', 'token=' . $this->session->data['token'] . '&sort=status' . $url, 'SSL');
		...
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('module/blog/comment_list', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$data['footer'] = $this->load->controller('common/footer');
        $data['handy_box'] = $this->load->view('module/blog/partial/header.tpl', $data);
		$this->response->setOutput($this->load->view('module/blog/comment_list.tpl', $data));
	}
	...
	protected function getCommentForm() {
		...
		if (!isset($this->request->get['comment_id'])) {
			$data['action'] = $this->url->link('module/blog/comment_add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('module/blog/comment_edit', 'token=' . $this->session->data['token'] . '&comment_id=' . $this->request->get['comment_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('module/blog/comment', 'token=' . $this->session->data['token'] . $url, 'SSL');
        ...
        $data['article_href'] = $this->url->link('module/blog/article_edit', 'token=' . $this->session->data['token'] . '&article_id=' . $comment_info['article_id'], 'SSL');

		$data['header'] = $this->load->controller('common/header');
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');
        $data['handy_box'] = $this->load->view('module/blog/partial/header.tpl', $data);
		$this->response->setOutput($this->load->view('module/blog/comment_form.tpl', $data));
	}
	...
	public function author_add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateAuthorForm()) {
			...
			$this->response->redirect($this->url->link('module/blog/author_list', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getAuthorList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/blog/author_list', 'token=' . $this->session->data['token'], 'SSL')
		);
        
		$data['add'] = $this->url->link('module/blog/author_add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('module/blog/author_delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['authors'][] = array(
				...
				'name'            => $result['name'],
				'sort_order'      => $result['sort_order'],
				'edit'            => $this->url->link('module/blog/author_edit', 'token=' . $this->session->data['token'] . '&author_id=' . $result['author_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('module/blog/author_list', 'token=' . $this->session->data['token'] . '&sort=name' . $url, 'SSL');
		$data['sort_sort_order'] = $this->url->link('module/blog/author_list', 'token=' . $this->session->data['token'] . '&sort=sort_order' . $url, 'SSL');
		...
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('module/blog/author_list', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$data['footer'] = $this->load->controller('common/footer');
        $data['handy_box'] = $this->load->view('module/blog/partial/header.tpl', $data);
		$this->response->setOutput($this->load->view('module/blog/author_list.tpl', $data));
	}
	...
	protected function getAuthorForm() {
		...
		if (!isset($this->request->get['author_id'])) {
			$data['action'] = $this->url->link('module/blog/author_add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('module/blog/author_edit', 'token=' . $this->session->data['token'] . '&author_id=' . $this->request->get['author_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('module/blog/author', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$data['footer'] = $this->load->controller('common/footer');
        $data['handy_box'] = $this->load->view('module/blog/partial/header.tpl', $data);
		$this->response->setOutput($this->load->view('module/blog/author_form.tpl', $data));
	}
    ...
    // SETTIGNGS
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateSettingsForm()) {
			...
			$this->response->redirect($this->url->link('module/blog/settings', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getSettingsForm() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/blog/settings', 'token=' . $this->session->data['token'], 'SSL')
		);

        $data['action'] = $this->url->link('module/blog/settings', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['cancel'] = $this->url->link('module/blog', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$data['footer'] = $this->load->controller('common/footer');
          $data['handy_box'] = $this->load->view('module/blog/partial/header.tpl', $data);
		$this->response->setOutput($this->load->view('module/blog/settings_form.tpl', $data));
	}
